...
public class RequestBase {
	...
	public RequestBase(String urlStr, String authorizationKey) {
		this.urlStr = urlStr;
	...
	public HttpURLConnection sendRequest(RequestMethod method, ContentType contentType,ContentLength contentLength, Map<String, String> params, String body) {
	...
	public HttpURLConnection sendRequest(RequestMethod method, ContentType contentType, ContentLength contentLength, Map<String, String> params) {
	...
	public HttpURLConnection sendRequest(RequestMethod method, ContentType contentType,Map<String, String> params, String body) {
